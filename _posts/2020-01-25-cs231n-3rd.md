...
<center>![Gradient Descent](/public/images/gradient_multidimentional.gif)</center>
...
딥러닝에서 학습과정은 데이터를 입력부터 출력까지의 forward pass(순방향 과정)와 출력으로부터 $W$를 업데이트하는 backward pass(역방향 과정)로 구분할 수 있다. 전체 데이터 셋에 대해 순방향+역방향 과정이 전부 완료되면 1 epoch이 완료되었다고 한다.
...
<center>![SGD](/public/images/SGD.png)</center>
